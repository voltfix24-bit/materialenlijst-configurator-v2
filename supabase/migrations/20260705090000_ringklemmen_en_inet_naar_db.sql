...
--
-- Ringklem-specificaties en I-Net standaardartikelen stonden hardcoded in
-- src/lib/configurator/types.ts en omzeilden daarmee de assortiment-sync,
-- impactanalyse en datakwaliteit-checks. Vanaf nu zijn ze beheerbaar via
-- Beheer → Hardware. De code valt terug op de oude hardcoded lijst zolang
-- deze migratie niet is uitgevoerd.
